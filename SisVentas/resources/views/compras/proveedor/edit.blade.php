	...
	<div class="row">
		...
		<div class="col-lg-6 col-sm-6 col-xs-12">
			<div class="form-group">
				...
				<input type="text" name="num_documento" class="form-control" placeholder="Numero documento..." value="{{$persona->num_documento}}">
			</div>
		</div>
		<div class="col-lg-6 col-sm-6 col-xs-12">
			<div class="form-group">
				<label for="telefono">Telefono</label>
				<input type="text" name="telefono" class="form-control" placeholder="Telefono..." value="{{$persona->telefono}}">
			</div>
		</div>
		<div class="col-lg-6 col-sm-6 col-xs-12">
			<div class="form-group">
